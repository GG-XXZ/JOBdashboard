...
- Voluntary self-ID defaults to blank, "Prefer not to say", or decline/skip when the form allows it. If the user does not configure exact answers, tell them JOBdashboard will default to non-disclosure.
