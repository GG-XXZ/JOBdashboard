...
Never include the user's private materials in a public JOBdashboard repo:
...
JOBdashboard should make the workflow more structured and less draining, not remove human responsibility.
